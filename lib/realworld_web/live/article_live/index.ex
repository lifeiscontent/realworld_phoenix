defmodule RealworldWeb.ArticleLive.Index do
  ...
  defp apply_action(socket, :index, params) do
    ...
    {articles, page_title} =
      if tag_name do
        {Blog.list_articles_by_tag(tag_name, socket.assigns.current_user,
  ...
  defp apply_action(socket, :following, params) do
    ...
    {articles, page_title} =
      if tag_name do
        {Blog.list_following_articles_by_tag(tag_name, socket.assigns.current_user,
           limit: socket.assigns.per_page
         ), "Your Feed"}
      else
  ...
  def handle_event("next-page", _params, socket) do
    ...
    if last_article_id == nil do
      ...
      articles =
        case {action, socket.assigns[:tag]} do
          {:index, nil} ->
